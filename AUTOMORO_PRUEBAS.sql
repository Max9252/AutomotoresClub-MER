...
ALTER TABLE AC_PROVEEDOR ADD CONSTRAINT Proveedor_PK PRIMARY KEY ( Id_Usuario ) ;
...
CREATE TABLE AC_TIPO_PROVEEDOR
  (
    ...
    AC_PROVEEDOR_Id_Usuario VARCHAR2 (15) NOT NULL
  ) ;
ALTER TABLE AC_TIPO_PROVEEDOR ADD CONSTRAINT AC_TIPO_PROVEEDOR_PK PRIMARY KEY ( AC_P_PROVEEDOR_Codigo, AC_PROVEEDOR_Id_Usuario ) ;
...
ALTER TABLE AC_VEHICULO ADD CONSTRAINT Asociado_PK PRIMARY KEY ( Id_usuario ) ;
...
ALTER TABLE AC_PROVEEDOR ADD CONSTRAINT ACUSUARIO_FK FOREIGN KEY ( Id_Usuario ) REFERENCES USUARIO ( Id_Usuario ) ;
...
ALTER TABLE AC_TIPO_PROVEEDOR ADD CONSTRAINT AC_PROVEEDOR_FK FOREIGN KEY ( AC_PROVEEDOR_Id_Usuario ) REFERENCES AC_PROVEEDOR ( Id_Usuario ) ;

ALTER TABLE AC_PRODUCTOS ADD CONSTRAINT AC_PROVEEDOR_FKv2 FOREIGN KEY ( Id_Usuario ) REFERENCES AC_PROVEEDOR ( Id_Usuario ) ;
...
ALTER TABLE AC_PROMOCION_PERMANENTE ADD CONSTRAINT USUARIO_FK FOREIGN KEY ( Id_Usuario ) REFERENCES USUARIO ( Id_Usuario ) ;

ALTER TABLE "AC.FACTURA" ADD CONSTRAINT USUARIO_FKv2 FOREIGN KEY ( Id_Usuario ) REFERENCES USUARIO ( Id_Usuario ) ;

ALTER TABLE AC_AFILIACION ADD CONSTRAINT USUARIO_FKv4 FOREIGN KEY ( Id_Usuario ) REFERENCES USUARIO ( Id_Usuario ) ;
